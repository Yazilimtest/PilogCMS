            ...
            <div class="pull-left">
                <div class="btn-toolbar">
                    <a href="{{ URL::route('admin.category.create') }}" class="btn btn-primary">
                        <span class="glyphicon glyphicon-plus"></span>&nbsp;Kategori Ekle
                    </a>
                </div>
            </div>
            <br>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{ URL::route('admin.category.show', array($category->id)) }}">
                                            <span class="glyphicon glyphicon-eye-open"></span>&nbsp;Kategoriyi Göster
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::route('admin.category.edit', array($category->id)) }}">
                                            <span class="glyphicon glyphicon-edit"></span>&nbsp;Kategoriyi Düzenle
                                        </a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
