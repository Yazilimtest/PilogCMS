...
<div class="container">
        ...
        <h3>
          Yeni Yazı Oluştur
            <div class="pull-right">
                {{ HTML::link('/admin/post','Geri', array('class'=>'btn btn-primary')) }}
            </div>
        </h3>
    </div>
    {{ Form::open(array('action' => 'App\Controllers\Admin\PostController@store','files' => true)) }}
    <!-- Title -->
    ...
    <div class="control-group {{ $errors->has('image') ? 'has-error' : '' }}">
        <label class="control-label" for="title">İmage</label>
